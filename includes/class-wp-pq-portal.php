...
class WP_PQ_Portal
{
    ...
    public static function render_shortcode(): string
    {
        ...
        echo '  <section class="wp-pq-hero">';
        echo '    <div class="wp-pq-hero-copy">';
        echo '      <p class="wp-pq-kicker">Readspear Workflow</p>';
        echo '      <h2>Client Priority Portal</h2>';
        echo '      <p>Create requests, reprioritize work, track deadlines, and keep every task conversation in one place.</p>';
        echo '    </div>';
        echo '    <div class="wp-pq-hero-actions">';
        echo '      <button class="button button-primary" type="button" id="wp-pq-open-create">New Request</button>';
        echo '      <div class="wp-pq-view-toggle">';
        echo '        <button class="button button-primary is-active" id="wp-pq-view-board" type="button">Board View</button>';
        echo '        <button class="button" id="wp-pq-view-calendar" type="button">Calendar View</button>';
        echo '      </div>';
        echo '      <button class="button" type="button" id="wp-pq-open-inbox">Alerts <span id="wp-pq-inbox-count" class="wp-pq-inline-count">0</span></button>';
        echo '    </div>';
        echo '  </section>';
        ...
        echo '        <select name="client_user_id" id="wp-pq-create-client"></select>';
        echo '      </label>';
        echo '      <label>Job';
        ...
        echo '        <input type="text" name="new_bucket_name" id="wp-pq-create-new-bucket" placeholder="Only if this client needs a new job bucket">';
        echo '      </label>';
        ...
        echo '        <p class="wp-pq-panel-note">Open any card to review details, files, approvals, and messages in the task drawer.</p>';
        echo '      </div>';
        echo '      <div class="wp-pq-board-toolbar">';
        ...
        echo '          </label>';
        echo '          <label class="wp-pq-filter-control" id="wp-pq-bucket-filter-wrap" hidden>Job';
        echo '            <select id="wp-pq-bucket-filter"></select>';
        echo '          </label>';
        echo '          <button class="button" type="button" id="wp-pq-clear-filters" hidden>Clear</button>';
        echo '        </div>';
      ...
      echo '      <button class="button" type="button" id="wp-pq-close-inbox">Close</button>';
        ...
        echo '      <div id="wp-pq-current-task-meta" class="wp-pq-drawer-meta">Choose a board card or calendar item to open its workspace.</div>';
        ...
        echo '          <strong>Action owner</strong>';
        echo '          <p id="wp-pq-assignment-summary" class="wp-pq-panel-note">Choose who is responsible for the next step.</p>';
        echo '        </div>';
