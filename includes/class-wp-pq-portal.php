...
class WP_PQ_Portal
{
    ...
    public static function render_shortcode(): string
    {
        ...
        echo '        <div id="wp-pq-job-nav" class="wp-pq-job-nav"></div>';
        echo '      </div>';
        echo '      <div class="wp-pq-binder-section">';
        echo '        <p class="wp-pq-binder-label">Views</p>';
        echo '        <div class="wp-pq-saved-view-list" id="wp-pq-saved-view-list">';
        echo '          <button class="button is-active" type="button" data-saved-view="all">All tasks</button>';
        echo '          <button class="button" type="button" data-saved-view="awaiting_me">Awaiting me</button>';
        echo '          <button class="button" type="button" data-saved-view="awaiting_client">Awaiting client</button>';
        echo '          <button class="button" type="button" data-saved-view="delivered">Delivered</button>';
        echo '          <button class="button" type="button" data-saved-view="unbilled">Unbilled</button>';
        echo '        </div>';
        echo '      </div>';
        echo '      <div class="wp-pq-binder-section">';
        echo '        <p class="wp-pq-binder-label">Summary</p>';
