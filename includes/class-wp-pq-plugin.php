...
final class WP_PQ_Plugin
{
    ...
    public function boot(): void
    {
        ...
        WP_PQ_Migrations::migrate_legacy_statuses();
        WP_PQ_Migrations::migrate_workflow_status_model();
        WP_PQ_Migrations::migrate_task_context_fields();
        WP_PQ_Migrations::migrate_client_accounts();
        WP_PQ_Migrations::migrate_named_default_buckets();
        WP_PQ_Migrations::migrate_invoice_draft_models();
        WP_PQ_Migrations::migrate_work_statement_snapshots();
        WP_PQ_Migrations::ensure_default_billing_buckets();
        WP_PQ_Migrations::migrate_workflow_ledger_model();
        WP_PQ_Migrations::migrate_portal_manager_model();
        WP_PQ_Migrations::migrate_ledger_closure_model();
        WP_PQ_Migrations::migrate_notification_event_keys();
        WP_PQ_Migrations::migrate_rejected_event_key();
        WP_PQ_Migrations::migrate_clear_false_archived_at();
        WP_PQ_Migrations::migrate_drive_storage_model();
        WP_PQ_Migrations::migrate_files_link();
        WP_PQ_Migrations::migrate_per_user_google_tokens();
