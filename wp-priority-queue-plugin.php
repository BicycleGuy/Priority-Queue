...
require_once WP_PQ_PLUGIN_DIR . 'includes/class-wp-pq-migrations.php';
require_once WP_PQ_PLUGIN_DIR . 'includes/class-wp-pq-housekeeping.php';
require_once WP_PQ_PLUGIN_DIR . 'includes/class-wp-pq-google-auth.php';
require_once WP_PQ_PLUGIN_DIR . 'includes/class-wp-pq-mail.php';
require_once WP_PQ_PLUGIN_DIR . 'includes/class-wp-pq-files.php';
require_once WP_PQ_PLUGIN_DIR . 'includes/class-wp-pq-calendar.php';
require_once WP_PQ_PLUGIN_DIR . 'includes/class-wp-pq-sanitizer.php';
...
require_once WP_PQ_PLUGIN_DIR . 'includes/class-wp-pq-drive.php';
